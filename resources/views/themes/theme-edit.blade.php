...
@section('content')
                    ...
                    <form  method="post" id="edit_project_setting" action="{{route('themes.update',$theme->id)}}" enctype="multipart/form-data">
                     @csrf
                     @method('PUT')
                                              ...
                                              <div class="kt-section__body">
                                                  ...
                                                  <input type="hidden" name="oldfavicon" value="{{$theme->favicon}}">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_apps_user_add_avatar">
                                                            <div class="kt-avatar__holder" style="background-image: url({{$favicon}});" id="favicon_preview"></div>
                                                  ...
                                                  <div class="form-group row">
                                                    <input type="hidden" name="oldimage" value="{{$theme->image}}">
                                                      ...
                                                      <div class="col-lg-9 col-xl-6">
                                                          <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_apps_user_add_avatar">
                                                              <div class="kt-avatar__holder" style="background-image: url({{$image}});" id="image_preview"></div>
                                                              <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change avatar">
                                                                  <i class="fa fa-pen"></i>
                              ...
                              <div class="kt-section kt-section--first themes">
                                <div class="row">
																	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 custom-button">
																			<a href="{{url('/modules/create',$theme->id)}}" class="btn btn-label-brand btn-bold">Add Module</a>
																	</div>
																	<?php
																	if(count($modules) > 0){ ?>
                                  @foreach($modules as $module)
                                        ...
                                        <div class="theme-item">
                                          <div class="kt-widget__media">
                                            ...
                                            <div class="overlay-options">
                                              <a href="{{ route('modules.edit',$module->id) }}" class="edit">
                                      ...
                                      <!-- <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        <div class="kt-portlet kt-portlet--height-fluid" style="background:url({{ $image }}); background-size:cover;">
                                          <div class="kt-portlet__head kt-portlet__head--noborder">
                                            ...
                                            <div class="kt-portlet__head-toolbar">
                                              ...
                                              <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="kt-nav">
                                                  <li class="kt-nav__item">
                                                    <a href="{{ route('modules.edit',$module->id) }}" class="kt-nav__link">
                                                  ...
                                                  <li class="kt-nav__item">
                                                    <a href="{{url('module/destroy/'.$module->id)}}" class="kt-nav__link">
                                              ...
                                              <div class="kt-widget__head">
                                                ...
                                                <div class="kt-widget__content">
                                                  <div class="kt-widget__section">
                                                    ...
                                                    <div class="kt-widget__action">
                                                      <a href="{{ route('modules.edit',$module->id) }}"  class="btn btn-label-brand btn-bold btn-sm btn-upper">Edit Module </a>
                                                    </div>
                                                    </br>
                                                  </div>
                                                </div>
                                  ...
                                  <div class="kt-wizard-v1__form">
                                      <div class="row">
										...
										<div class="kt-form__actions">
											...
											<a href="{{url('themes')}}" class="btn btn-brand btn-bold">Cancel</a>
