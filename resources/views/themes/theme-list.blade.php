							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__group" id="kt_subheader_search">
										...
										{{$themes->total()}} Total </span>
										<form method="post" class="kt-margin-l-20" id="kt_subheader_search_form" action="{{url('themes/search')}}">
								...
								<div class="kt-subheader__toolbar displayblock">
									...
									<a href="{{url('/themes/create')}}" class="btn btn-label-brand btn-bold">Add Theme</a>
								</div>
							</div>
						</div>
											...
											<div class="kt-pagination kt-pagination--brand">
												...
												<div class="kt-pagination__toolbar">
													...
													<span class="pagination__desc">
														Displaying {{$themes->count()}} of {{$themes->total()}} records
													</span>
												</div>
											</div>
							...
							<div class="row">
							  ...
							  ?>
								<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
									<div class="kt-portlet kt-portlet--height-fluid" style="{{$background}}">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<ul class="kt-nav">
														<li class="kt-nav__item">
															<a href="{{ route('themes.edit',$theme->id) }}" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon2-edit"></i>
																<span class="kt-nav__link-text">Edit</span>
															</a>
														</li>
														<li class="kt-nav__item">
															<a href="{{url('themes/duplicate',$theme->id)}}" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon2-copy"></i>
																<span class="kt-nav__link-text">Duplicate</span>
															</a>
														</li>
														<!-- <li class="kt-nav__item">
															<a href="{{url('sites/create')}}" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon2-link"></i>
																<span class="kt-nav__link-text">Create New Site</span>
															</a>
														</li> -->
														<li class="kt-nav__item">
															<a href="{{url('modules',$theme->id)}}" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon2-link"></i>
														...
														<li class="kt-nav__item">
															<a href="{{url('themes/destroy/'.$theme->id)}}" class="kt-nav__link">
												...
												<div class="kt-widget__head">
													<div class="kt-widget__media">
														...
														if($theme->favicon != 'null'){
														 ...
														 ?>
														<img class="kt-widget__img kt-hidden-" src="{{ $favicon}}" alt="image">
													...
													<div class="kt-widget__content">
														<div class="kt-widget__section">
															<a href="{{ route('themes.edit',$theme->id) }}" class="kt-widget__username">
																{{$theme->name}}
															</a>
															...
															<div class="kt-widget__action">
																<a href="{{ route('themes.edit',$theme->id) }}"  class="btn btn-label-brand btn-bold btn-sm btn-upper">Edit Theme </a>
															</div>
														</br>
														</div>
													</div>
