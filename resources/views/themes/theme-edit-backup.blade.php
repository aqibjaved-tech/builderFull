                                        ...
                                        <div class="col-9">
                                          <div class="kt-checkbox-list">
                                            <label class="kt-checkbox">
                                              <input type="checkbox" <?php if($theme->platforms == 'For Exchange Collective'){ echo "checked='checked'"; } ?>  name="platforms" value="For Exchange Collective"> For Exchange Collective
                                              <span></span>
                                            </label>
                                          </div>
                                        </div>
