			...
			<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
								...
								<div class="kt-subheader__toolbar">
									<a href="{{url('modules',$themeid)}}" class="btn btn-default btn-bold">
										Back </a>
									<div class="btn-group">
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									<div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_projects_add" data-ktwizard-state="step-first">
										...
										<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
											...
											<!--begin: Form Wizard Form-->
											<form method="post" class="kt-form kt-form--label-right" action="{{url('modules/store')}}" enctype="multipart/form-data">
												@csrf
												...
												<div class="kt-form__actions">
													...
													<a href="{{url('modules',$themeid)}}" class="btn btn-brand btn-bold">Cancel</a>
