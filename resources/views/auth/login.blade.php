    ...
    <head>
        ...
        <!--end::Fonts -->
            ...
            <!--begin::Page Custom Styles(used by this page) -->
                             <link href={{ asset("assets/css/demo3/pages/login/login-6.css")}} rel="stylesheet" type="text/css" />
        ...
        <!--begin::Layout Skins(used by all pages) -->
                <!--end::Layout Skins -->
<link href={{ asset("assets/css/demo3/custom.css")}}  rel="stylesheet" type="text/css" />
        <link rel="shortcut icon" href="{{asset('assets/media/company-logos/fav.png')}}" />
    </head>
    <!-- end::Head -->
    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
                ...
                <div class="kt-login__container">
                    <div class="kt-login__body">
                        <div class="kt-login__logo">
                            <a href="#">
                                <img src="{{ asset('assets/media/company-logos/logo.png')}}">
                            </a>
                        </div>
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background-image: url({{asset("assets/media/bg/login-background.png")}})">
...
<!-- end:: Page -->
    	...
    	<!--begin::Global Theme Bundle(used by all pages) -->
            ...
            <!--begin::Page Scripts(used by this page) -->
                            <script src={{ asset("assets/js/demo3/pages/login/login-general.js")}} type="text/javascript"></script>
                        <!--end::Page Scripts -->
            </body>
    <!-- end::Body -->
</html>
