										...
										<div class="kt-widget__top">
											...
											<div class="kt-widget__content">
												<div class="kt-widget__head">
													<a href="#" class="kt-widget__title">{{$site->name}}</a>
														...
														<div class="row">
															<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
																<div class="kt-section__body">
																	<input type="hidden" name="oldimage" value="{{$site->logo}}">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-lg-9 col-xl-6">
																			<input class="form-control" type="text" value="{{$site->name}}" name="name">
																		</div>
																	</div>
																	<div class="form-group row">
																		<label class="col-xl-3 col-lg-3 col-form-label">Description</label>
																		<div class="col-lg-9 col-xl-6">
																		<textarea class="form-control" id="exampleTextarea" rows="3" name="description">{{$site->description}}</textarea>
																		</div>
																	</div>
																	<div class="form-group row">
																		<label class="col-xl-3 col-lg-3 col-form-label">URL</label>
																		<div class="col-lg-9 col-xl-6">
																		<input class="form-control" type="url" value="{{$site->url}}" name="url">
																		</div>
																	</div>
																	<div class="form-group row">
																		...
																		<div class="col-lg-9 col-xl-6">
																			<select class="form-control fieldtype" name="theme_name" id="theme_name">
																				@foreach ($themes as $theme)
																					<option <?php if($site->theme == $theme->themeid){ echo "selected='selected'"; } ?> value="{{$theme->themeid}}">{{$theme->themename}}</option>
																				@endforeach
																			</select>
																		</div>
																	</div>
																	<div class="form-group row">
																		...
																		<div class="col-lg-9 col-xl-6">
																		<input class="form-control" type="text" name="apikey" value="{{$site->apikey}}">
																		</div>
																	</div>
																	<div class="form-group row">
																		<label class="col-xl-3 col-lg-3 col-form-label">Api Secret</label>
																		<div class="col-lg-9 col-xl-6">
																		<input class="form-control" type="text" name="apisecret" value="{{$site->apisecret}}">
																		</div>
																	</div>
																	<div class="form-group row">
																		<label class="col-xl-3 col-lg-3 col-form-label">Api Email</label>
																		<div class="col-lg-9 col-xl-6">
																		<input class="form-control" type="email" name="apiemail" value="{{$site->apiemail}}">
																		</div>
																	</div>
																	<input type="hidden" name="oldimage" value="{{$site->logo}}">
																</div>
												...
												<div class="kt-form__body">
													<div class="row">
														<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 custom-button">
															<a href="{{url('/pages/create',$site->id)}}" class="btn btn-label-brand btn-bold" style="float:left;">Add Page</a>
														</div>
														<?php
														if(count($pages) > 0){ ?>
														@foreach($pages as $page)
															<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
																<div class="pages-list @if($page->active == 1) active-page @endif">
																	<div class="page-img">
																		<?php
																			//echo $page->image;
																			if($page->image != ''){
																		...
																		?>
																		<img class="kt-widget__img kt-hidden-" src="{{$imagepath}}" alt="image">
																	...
																	<div class="page-details">
																		<div class="page-title">
																			<h3>
																				<a href="{{url('/frontend/?siteid='.$page->siteid.'&pageid='.$page->id)}}" class="kt-widget__username">
																					{{$page->title}}
																				</a>
																			</h3>
																		</div>
																		...
																		<div class="more-details">
																			<ul>
																				<li>
																					<a href="{{ url('/frontend/?siteid='.$page->siteid.'&pageid='.$page->id) }}" class="kt-nav__link">
																				...
																				<li>
																					<a href="{{url('pages/destroy/'.$page->id)}}" class="kt-nav__link">
																			...
																			<!-- <div class="kt-widget__action">
																				<a href="{{ route('pages.edit',$page->id) }}"  class="btn btn-label-brand btn-bold btn-sm btn-upper">Edit Page </a>
																			</div> -->
																		</div>
																	</div>
																</div>
																	...
																	<div class="kt-portlet__head kt-portlet__head--noborder">
																		...
																		<div class="kt-portlet__head-toolbar">
																			...
																			<div class="dropdown-menu dropdown-menu-right">
																				<ul class="kt-nav">
																					<li class="kt-nav__item">
																						<a href="{{ url('/frontend/?siteid='.$page->siteid) }}" class="kt-nav__link">
																		...
																		<?php for($a=0; $a< count($settings[$i]->groups->fieldname); $a++){
																			...
																			?>
																				...
																				<div class="form-group form-group-sm row">
																					<label class="col-xl-2 col-lg-2 col-form-label align-right">{{$settings[$i]->groups->fieldname[$a]}}</label>
																					<div class="col-lg-9 col-xl-6">
																						<span class="kt-switch">
																							...
																							if(isset($site_settings->settings->$groupname->$fieldname)){
																							 ...
																							 ?>
																							<label>
																								<input type="checkbox" <?php if($boolean == 1){ echo "checked='checked'"; } ?> name="settings[{{$groupname}}][{{$fieldname}}]" value="1">
																								<span></span>
																							</label>
																						</span>
																					</div>
																				...
																				<div class="form-group form-group-sm row">
																					<label class="col-xl-2 col-lg-2 col-form-label align-right">{{$settings[$i]->groups->fieldname[$a]}}</label>
																					<div class="col-lg-9 col-xl-6">
																								<input type="text" class="form-control" name="settings[{{$groupname}}][{{$fieldname}}]" value="<?php echo $colorpicker; ?>">
																					</div>
																				</div>
																				...
																				<div class="form-group row customfile">
																					<label class="col-xl-2 col-lg-2 col-form-label align-right">{{$settings[$i]->groups->fieldname[$a]}}</label>
																					<div class="col-lg-9 col-xl-6">
																						<input type="file" class="custom-file-input" id="customFile" name="settingfile[{{$groupname}}][{{$fieldname}}]">
																						...
																						<input type="hidden" class="form-control" name="settingoldfile[{{$groupname}}][{{$fieldname}}]" value="{{$filename}}">
																					</div>
																				</div>
																				@else
																					<?php
																					...
																					<div class="form-group form-group-sm row">
																						<label class="col-xl-2 col-lg-2 col-form-label align-right">{{$settings[$i]->groups->fieldname[$a]}}</label>
																						<div class="col-lg-9 col-xl-6">
																							<input type="{{$settings[$i]->groups->fieldtype[$a]}}" class="form-control" name="settings[{{$groupname}}][{{$fieldname}}]" value="<?php echo $inputvalue; ?>">
																						</div>
																					</div>
																				@endif
																		<?php } ?>
