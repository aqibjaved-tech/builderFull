								...
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total">
											Enter Site details and submit </span>
									</div>
								</div>
							...
							<div class="kt-portlet">
								<div class="kt-portlet__body kt-portlet__body--fit">
									<div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_projects_add" data-ktwizard-state="step-first">
										...
										<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper site-form">

											<!--begin: Form Wizard Form-->
											<form method="post" class="kt-form kt-form--label-right" action="{{route('sites.store')}}" enctype="multipart/form-data">
												@csrf
													...
													<div class="row">
														<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6">
																<input class="form-control" type="text" name="apisecret">
																</div>
															</div>
															<div class="form-group row">
																<label class="col-xl-3 col-lg-3 col-form-label">Api Email</label>
																<div class="col-lg-9 col-xl-6">
																<input class="form-control" type="email" name="apiemail">
																</div>
															</div>
															<div class="form-group row">
												...
												<div class="kt-form__actions">
														...
														<div class="btn btn-brand btn-md btn-tall btn-wide kt-font-bold kt-font-transform-u" id="nextaction" data-ktwizard-type="action-next">
																Next Step
														</div>
												</div>
												<!--end: Form Actions -->
