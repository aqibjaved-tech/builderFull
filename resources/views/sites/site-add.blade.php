...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
	...
	<div class="kt-subheader kt-grid__item" id="kt_subheader">
		<div class="kt-container kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				<a href="{{url('sites')}}" class="btn btn-default btn-bold">Back </a>
				<div class="btn-group">
	...
	<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
			...
			<div class="kt-portlet__body kt-portlet__body--fit">
				<div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_site_add" data-ktwizard-state="step-first">
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
						...
						<form method="post" id="kt_apps_site_add_form" class="kt-form kt-form--label-right" action="{{route('sites.create')}}" enctype="multipart/form-data">
							@csrf
		...
		<script src="{{asset('assets/js/demo3/pages/custom/projects/add-site.js')}}" type="text/javascript"></script>
...
$(document).ready(function(){
	...
	$('.theme-item').click(function(){
	 ...
	 $.ajax({
			 type: "GET",
			 url: "{{url('site/gettheme/')}}"+'/'+theme_name,
