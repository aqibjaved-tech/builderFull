        ...
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-tab ">
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item <?php echo $theme_activeclass; ?>" aria-haspopup="true">
                  <a href="{{url('themes')}}" class="kt-menu__link "><span class="kt-menu__link-text">Themes</span>
                  </a>
                </li>

                <li class="kt-menu__item <?php echo $site_activeclass; ?>" aria-haspopup="true">
                  <a href="{{url('sites')}}" class="kt-menu__link "><span class="kt-menu__link-text">Sites</span>
                  </a>
                </li>
