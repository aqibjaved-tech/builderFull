						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								...
								<div class="kt-subheader__toolbar">
									<a href="{{url('Pages/'.$page->themeid)}}" class="btn btn-default btn-bold">
										Back </a>
									<div class="btn-group">
										...
										<div class="kt-widget__top">
											...
											<div class="kt-widget__content">
												<div class="kt-widget__head">
													<a href="javascript:void(0);" class="kt-widget__title">{{$page->title}}</a>
								...
								<div class="kt-portlet__body">
									<div class="tab-content  kt-margin-t-20">
										...
										<div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
											...
											<?php //echo $page->id.'dsfasdfsd'; exit; ?>
											<form action="{{ route('pages.update',$page->id) }}" method="POST" enctype="multipart/form-data">
							         @csrf
							         @method('PUT')
											 	<input type="hidden" name="siteid" value="{{$page->siteid}}">
												...
												<div class="kt-section kt-section--first">
													<div class="kt-section__body">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6">
																	<select class="form-control" id="exampleSelectd" name="type">
																			<option <?php if($page->type == 'Home Page'){ echo "selected"; } ?> >Home Page</option>
																			<option <?php if($page->type == 'Content'){ echo "selected"; } ?> >Content</option>
																			<option <?php if($page->type == 'Collection'){ echo "selected"; } ?> >Collection</option>
																			<option <?php if($page->type == 'Product'){ echo "selected"; } ?> >Product</option>
																			<option <?php if($page->type == 'Cart'){ echo "selected"; } ?> >Cart</option>
																	</select>
																</div>
															</div>
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6">
																	<select class="form-control" id="exampleSelectd" name="status">
																			<option <?php if($page->status == 'Publish'){ echo "selected"; } ?> >Publish</option>
																			<option <?php if($page->status == 'Draft'){ echo "selected"; } ?> >Draft</option>
																			<option <?php if($page->status == 'Trash'){ echo "selected"; } ?> >Trash</option>
																			<option <?php if($page->status == 'Archive'){ echo "selected"; } ?> >Archive</option>
																	</select>
																</div>
															</div>
															...
															<div class="form-group form-group-last row">
																...
																<div class="col-3">
																		<span class="kt-switch kt-switch--lg kt-switch--icon">
																			<label>
																				<input type="checkbox" name="active" <?php if($page->active == 1){ echo "checked"; } ?> value="1">
																				<span></span>
																			</label>
																		</span>
																	</div>
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6">
																	<input class="form-control" type="text" name="filepath" value="{{$page->filepath}}">
																</div>
															</div>
															<div class="form-group row">
																<label class="col-xl-3 col-lg-3 col-form-label">File Content</label>
																<div class="col-lg-9 col-md-9 col-sm-12">
																	<textarea hidden class="form-control" id="filecontent" rows="3" name="html">{{$page->filecontent}}</textarea>

																	<div class="summernote" id="kt_summernote_1">{{htmlspecialchars_decode($page->filecontent)}}</div>
																</div>
															</div>
															<div class="form-group row">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6">
																	<div class="input-group date">
																		<input type="text" class="form-control" name="sceduledate" value="{{date('m/d/Y', strtotime($page->scheduledate))}}" id="kt_datepicker_4_1" />
															...
															<!-- <div class="form-group row customfile">
																...
																<label class="col-xl-3 col-lg-3 col-form-label">Page Logo</label>
																<div class="col-lg-9 col-xl-6">
															...
															<?php
																	if($page->image != ''){
																		$image = asset('public/pageAssets/'.$page->image);
																	}else{
												...
												<div class="kt-form__actions">
													...
													<button type="submit" id="submitbutton" class="btn btn-brand btn-bold">Save Changes</button>
													<a href="{{url('Pages/'.$page->themeid)}}" class="btn btn-brand btn-bold">Cancel</a>
