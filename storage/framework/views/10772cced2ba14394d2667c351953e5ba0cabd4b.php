		...
		<div class="kt-container kt-container--fluid ">
			<div class="kt-subheader__main">
				...
				<div class="kt-subheader__group" id="kt_subheader_search">
					<span class="kt-subheader__desc" id="kt_subheader_total">Enter Site details and submit </span>
				</div>
			</div>
			<div class="kt-subheader__toolbar">
				<a href="<?php echo e(url('sites')); ?>" class="btn btn-default btn-bold">Back </a>
				<div class="btn-group">
	...
	<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		<div class="kt-portlet">
			<div class="kt-portlet__body kt-portlet__body--fit">
				<div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_site_add" data-ktwizard-state="step-first">
					<div class="kt-grid__item">
						...
						<div class="kt-wizard-v1__nav">
							<div class="kt-wizard-v1__nav-items">
								...
								<a class="kt-wizard-v1__nav-item" href="javascript:void(0);" data-ktwizard-type="step">
									<div class="kt-wizard-v1__nav-body">
										<div class="kt-wizard-v1__nav-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--xl">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
						...
						<form method="post" id="kt_apps_site_add_form" class="kt-form kt-form--label-right" action="<?php echo e(route('sites.create')); ?>" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
											...
											<div class="col-xl-12">
												<div class="kt-section__body">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
														<input class="form-control" type="url" name="url" id="siteurl">
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<div class="row">
																<div class="col-md-6 col-xs-12">
																	<button type="button" class="btn btn-brand" data-toggle="modal" data-target="#kt_modal_KTDatatable_local">Choose Theme</button>
																</div>
																<input type="hidden" id="theme_name" name="theme_name" value="">
																<div class="col-md-6 col-xs-12">
																	<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_apps_user_add_avatar">
																		<?php $image = asset("images/no-image.jpg"); ?>
																			<div class="kt-avatar__holder" id="theme_thumbnail" style="background-image: url(<?php echo e($image); ?>);"></div>
																						...
																						<?php $__currentLoopData = $themes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																							<?php
																								if($theme->favicon !='' && $theme->favicon !='null'){
																									$background = asset("themeAssets/".$theme->favicon);
																								}else{
																									$background = asset("images/no-image.jpg");
																								}
																							?>
																							<div class="col-md-6 col-xs-12">
																								<div class="theme-item" id="<?php echo e($theme->id); ?>">
																									...
																									<div class="kt-widget__media">
																										<img class="kt-widget__img kt-hidden-" src="<?php echo e($background); ?>" alt="<?php echo e($theme->name); ?>">
																									</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
														<input class="form-control" type="text" name="apisecret" id="apisecret">
														</div>
													</div>
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Api Email</label>
														<div class="col-lg-9 col-xl-6">
														<input class="form-control" type="email" name="apiemail" id="apiemail">
														</div>
													</div>
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Api Password</label>
														<div class="col-lg-9 col-xl-6">
														<input class="form-control" type="password" name="apipassword">
														</div>
													</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-xl-12">
												<div class="kt-section__body">
													<div class="form-group row">
														<div class="col-lg-9 col-xl-6">
															<h3 class="kt-section__title kt-section__title-md"> Settings</h3>
														</div>
													</div>
		...
		<script src="<?php echo e(asset('assets/js/demo3/pages/custom/projects/add-site.js')); ?>" type="text/javascript"></script>
...
$(document).ready(function(){
	...
	$('.theme-item').click(function(){
	 ...
	 $.ajax({
			 type: "GET",
			 url: "<?php echo e(url('site/gettheme/')); ?>"+'/'+theme_name,
			 data: "theme_name="+theme_name,
			 success: function( response ) {
					$('#kt_apps_contacts_view_tab_4').html(response);
			 }
	 });
	});
});
...
<?php echo $__env->make('admin.layouts.header1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pageBuilder\resources\views/sites/site-add.blade.php ENDPATH**/ ?>