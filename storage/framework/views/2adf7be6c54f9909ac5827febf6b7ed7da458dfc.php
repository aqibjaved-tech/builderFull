<?php $__env->startSection('title', 'Module Lists'); ?>
	...
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-container  kt-container--fluid ">
			<div class="kt-subheader__main">
				...
				<div class="kt-subheader__group" id="kt_subheader_search">
					<span class="kt-subheader__desc" id="kt_subheader_total">
						<?php echo e($modules->total()); ?> Total </span>
			...
			<div class="kt-subheader__toolbar displayblock">
				...
				<a href="<?php echo e(url('/modules/create',$themeid)); ?>" class="btn btn-label-brand btn-bold">Add Module</a>
			</div>
		</div>
	</div>
	<!-- end:: Content Head -->
				...
				<div class="kt-portlet">
					<div class="kt-portlet__body">
						...
						<div class="kt-pagination kt-pagination--brand">
							...
							<input type="hidden" id="currentUrl" value="<?php echo e(URL::current()); ?>">
								<?php if($modules->total() > 10): ?>
								...
								<span class="pagination__desc">
									Displaying <?php echo e($modules->count()); ?> of <?php echo e($modules->total()); ?> records
								</span>
							</div>
						</div>
						<!--end: Pagination-->
					...
					<div class="theme-item">
						<div class="kt-widget__media">
							...
							<div class="overlay-options">
								<a href="<?php echo e(url('modules/edit',$module->id)); ?>" class="edit">
...
<?php echo $__env->make('admin.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\J.A\Documents\GitHub\pageBuilder\resources\views/modules/module-list.blade.php ENDPATH**/ ?>