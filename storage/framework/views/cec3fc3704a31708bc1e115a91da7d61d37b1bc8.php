...
<?php $__env->startSection('content'); ?>
        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                ...
                <div class="kt-subheader__toolbar">
                    <a href="<?php echo e(url('pages',$siteid)); ?>" class="btn btn-default btn-bold">
                        Back </a>
                    <div class="btn-group">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_page_add" data-ktwizard-state="step-first">
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                            ...
                            <!--begin: Form Wizard Form-->
                            <form method="post" id="kt_apps_page_add_form" class="kt-form kt-form--label-right" action="<?php echo e(url('pages/create/')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="siteid" value="<?php echo e($siteid); ?>">
                                <input type="hidden" name="exc_siteid" value="<?php echo e($exc_siteid); ?>">
                                        ...
                                        <div class="kt-section kt-section--first">
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control" type="text" name="filepath" value="<?php echo e(old('filepath')); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
    ...
    <script src="<?php echo e(asset('assets/js/demo3/pages/custom/projects/add-page.js')); ?>" type="text/javascript"></script>
...
<?php echo $__env->make('admin.layouts.header1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\J.A\Documents\GitHub\pageBuilder\resources\views/pages/page-add.blade.php ENDPATH**/ ?>