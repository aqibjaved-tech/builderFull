<?php $__env->startSection('title', 'Site Lists'); ?>
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total">
											<?php echo e($sites->count()); ?> Total </span>
								...
								<div class="kt-subheader__toolbar displayblock">
									...
									<a href="<?php echo e(url('/sites/create')); ?>" class="btn btn-label-brand btn-bold">Add Site</a>
								</div>
							</div>
						</div>
											...
											<div class="kt-pagination kt-pagination--brand">
												...
												<div class="kt-pagination__toolbar">
													...
													<span class="pagination__desc">
														Displaying <?php echo e($sites->count()); ?> of <?php echo e($sites->total()); ?> records
													</span>
												</div>
											</div>
							...
							<div class="row">
								<?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<div class="pages-list <?php if($site->active == 1): ?> active-page <?php endif; ?>">
											<div class="page-img">
												<?php
													if($site->logo != ''){
												...
												?>
												<img class="kt-widget__img kt-hidden-" src="<?php echo e($siteimage); ?>" alt="image">
											...
											<div class="page-details">
												<div class="page-title">
													<h3>
														<a href="<?php echo e(route('sites.edit',$site->id)); ?>" class="kt-widget__username">
												...
												<div class="more-details">
													<ul>
														<li>
															<a href="<?php echo e(url('pages/index',$site->id)); ?>" class="kt-nav__link">
																<i class="kt-nav__link-icon flaticon2-copy"></i>
																<span class="kt-nav__link-text">Pages</span>
															</a>
														</li>
														<li>
															<a href="<?php echo e(route('sites.edit',$site->id)); ?>" class="kt-nav__link">
														...
														<li>
															<a href="<?php echo e(url('site/destroy/'.$site->id)); ?>" class="kt-nav__link">
													...
													<!-- <div class="kt-widget__action">
														<a href="<?php echo e(route('sites.edit',$site->id)); ?>"  class="btn btn-label-brand btn-bold btn-sm btn-upper">Edit Page </a>
													</div> -->
												</div>
											</div>
										</div>
													...
													<div class="kt-widget__head">
														...
														<div class="kt-widget__content">
															<div class="kt-widget__section">
																...
																<div class="kt-widget__action">
																	<a href="<?php echo e(route('sites.edit',$site->id)); ?>"  class="btn btn-label-brand btn-bold btn-sm btn-upper">Edit Site </a>
																</div>
																</br>
															</div>
														</div>
...
<?php echo $__env->make('admin.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\J.A\Documents\GitHub\pageBuilder\resources\views/sites/site-list.blade.php ENDPATH**/ ?>