            ...
            <form>
                ...
                <div class="kt-head kt-head--skin-light kt-head--fit-x kt-head--fit-b">
                    ...
                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand  kt-notification-item-padding-x" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#topbar_notifications_events" role="tab" aria-selected="false">System Notification</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#topbar_notifications_logs" role="tab" aria-selected="false">Activity</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="kt-header__topbar-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
            <form>
                ...
                <!--begin: Head -->
                <div class="kt-head kt-head--skin-dark" style="background-image: url(<?php echo e(asset('assets/media/misc/bg.png')); ?>">
                    <h3 class="kt-head__title">
                        User Quick Actions
                ...
                <div class="kt-grid-nav kt-grid-nav--skin-light">
                    <div class="kt-grid-nav__row">
                        <a href="<?php echo e(route('themes.create')); ?>" class="kt-grid-nav__item">
                            ...
                            <span class="kt-grid-nav__title">Add Theme</span>
                            <!-- <span class="kt-grid-nav__desc">eCommerce</span> -->
                        </a>
                        <a href="<?php echo e(route('sites.create')); ?>" class="kt-grid-nav__item">
                            <span class="kt-grid-nav__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect id="bound" x="0" y="0" width="24" height="24" />
                            ...
                            <span class="kt-grid-nav__title">Add Site</span>
                            <!-- <span class="kt-grid-nav__desc">Console</span> -->
                        </a>
                    </div>
                    <div class="kt-grid-nav__row">
                        <a href="<?php echo e(url('register')); ?>" class="kt-grid-nav__item">
                          <span class="kt-grid-nav__icon">
                              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <a href="<?php echo e(url('support/create')); ?>" class="kt-grid-nav__item">
                          <span class="kt-grid-nav__icon">
                              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                      <rect id="bound" x="0" y="0" width="24" height="24" />
                            ...
                            <span class="kt-grid-nav__title">Create Ticket</span>
    ...
    <div class="kt-header__topbar-item kt-header__topbar-item--user">
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
            <div class="kt-header__topbar-user">
                ...
                <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder"><?php echo e(substr(Auth::user()->name, 0,1)); ?></span>
            </div>
        </div>
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">

            <!--begin: Head -->
            <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(<?php echo e(asset('assets/media/misc/bg.png')); ?>">
                <div class="kt-user-card__avatar">
                    <img class="kt-hidden" alt="Pic" src=<?php echo e(asset("assets/media/users/300_25.jpg")); ?> />

                    <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                    <span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"><?php echo e(substr(Auth::user()->name, 0,1)); ?></span>
                </div>
            ...
            <div class="kt-notification">
                <a href="<?php echo e(url('profile')); ?>" class="kt-notification__item">
                    <div class="kt-notification__item-icon">
                ...
                <a href="<?php echo e(url('my-support-tickets')); ?>" class="kt-notification__item">
                    <div class="kt-notification__item-icon">
                        <i class="flaticon2-help kt-font-success"></i>
                    </div>
                    <div class="kt-notification__item-details">
                        <div class="kt-notification__item-title kt-font-bold">
                            My Support Tickets
...
<!-- end:: Header Topbar -->
<?php /**PATH C:\Users\J.A\Documents\GitHub\pageBuilder\resources\views/admin/layouts/righttopnav.blade.php ENDPATH**/ ?>