<?php $__env->startSection('title', 'Add Theme'); ?>
                ...
                <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_projects_add" data-ktwizard-state="step-first">
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                        <!--begin: Form Wizard Form-->
                          <form class="kt-form" method="post" id="kt_apps_projects_add_form" action="<?php echo e(route('themes.create')); ?>" enctype="multipart/form-data">
                                                ...
                                                <div class="kt-section__body">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control" type="text" value="<?php echo e(old('name')); ?>" name="name" id="themename" placeholder="Theme Name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Description</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea class="form-control" rows="3" name="description" id="themedescription"><?php echo e(old('description')); ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                <input type="text" name="authorname" id="authorname" class="form-control" value="<?php echo e(old('authorname')); ?>" placeholder="Name" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="authoremail" id="authoremail" class="form-control" value="<?php echo e(old('authoremail')); ?>" placeholder="Email" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" id="authorwebsite" name="authorwebsite" placeholder="Website" value="<?php echo e(old('authorwebsite')); ?>">
                                                    ...
                                                    <div class="form-group form-group-last row">
                                                        ...
                                                        <div class="col-3">
                                                                <span class="kt-switch kt-switch--lg kt-switch--icon">
                                                                    <label>
                                                                        <input type="checkbox" <?php if(old('active') == 1){ echo "checked"; } ?> name="active" value="<?php echo e((old('active'))?old('active'):1); ?>">
                                                                        <span></span>
                                                                    </label>
                                                                </span>
                                                        </div>
...
<script src="<?php echo e(asset('assets/js/demo3/pages/custom/projects/add-project.js')); ?>" type="text/javascript"></script>
...
<?php echo $__env->make('admin.layouts.header1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pageBuilder\resources\views/themes/theme-add.blade.php ENDPATH**/ ?>