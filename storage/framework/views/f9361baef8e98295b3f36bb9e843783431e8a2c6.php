					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
					 ...
					 <?php endif; ?>
								...
								<div class="kt-subheader__main">
									...
									<!-- <div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total">
											---<?php echo e($module->name); ?>--- </span>
									</div> -->
								</div>
								<div class="kt-subheader__toolbar">
									<a href="<?php echo e(url('modules/'.$module->themeid)); ?>" class="btn btn-default btn-bold">
										Back </a>
									<div class="btn-group">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
										...
										<div class="kt-widget__top">
											...
											<div class="kt-widget__content">
												<div class="kt-widget__head">
													<a href="javascript:void(0);" class="kt-widget__title"><?php echo e($module->name); ?></a>
								...
								<div class="kt-portlet__body">
									<div class="tab-content  kt-margin-t-20">
										...
										<div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
											...
											<form action="<?php echo e(url('modules/update/'.$module->id)); ?>" method="POST" enctype="multipart/form-data">
							         <?php echo csrf_field(); ?>
							         <?php echo method_field('PUT'); ?>
											 	<input type="hidden" name="themeid" value="<?php echo e($module->themeid); ?>">
													...
													<div class="kt-section__body">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6">
																	<input class="form-control" type="text" name="name" value="<?php echo e($module->name); ?>">
																</div>
															</div>
															<div class="form-group row">
																<label class="col-xl-3 col-lg-3 col-form-label">Description</label>
																<div class="col-lg-9 col-xl-6">
																<textarea class="form-control" id="exampleTextarea" rows="3" name="description"><?php echo e($module->description); ?></textarea>
																</div>
															</div>
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6">
																	<select class="form-control" id="exampleSelectd" name="category">
																			<option><?php echo e($module->category); ?></option>
															...
															<!-- <div class="form-group row">
																...
																<div class="col-lg-9 col-xl-6"> -->
																	<!-- <textarea class="form-control" id="exampleTextarea" rows="3" name="html"><?php echo e($module->html); ?></textarea> -->
																<!-- </div>
															</div> -->
															<div class="form-group row">
																<label class="col-form-label col-lg-3 col-sm-12">Module Html</label>
																<div class="col-lg-9 col-md-9 col-sm-12">
																	<textarea hidden class="form-control" id="modulehtml" rows="3" name="html"><?php echo e($module->html); ?></textarea>
							...
							<input type="hidden" name="oldimage" value="<?php echo e($module->image); ?>">
							<div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Module Logo</label>
                                <div class="col-lg-9 col-xl-6">
                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_apps_user_add_avatar">
                                        <div class="kt-avatar__holder" style="background-image: url(<?php echo e($image); ?>);" id="logo_preview"></div>
                                        ...
                                        <span class="kt-avatar__cancel" data-toggle="kt-tooltip" title="" data-original-title="Cancel avatar">
                                            <i class="fa fa-times"></i>
												...
												<div class="kt-form__actions">
													...
													<a href="<?php echo e(url('modules/'.$module->themeid)); ?>" class="btn btn-brand btn-bold">Cancel</a>
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-9 col-xl-6">
															...
															<a href="<?php echo e(url('sites')); ?>" class="btn btn-clean btn-bold">Cancel</a>
														</div>
													</div>
												</div>
											</form>
...
<?php echo $__env->make('admin.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmajucr/builder.local/resources/views/modules/module-edit.blade.php ENDPATH**/ ?>